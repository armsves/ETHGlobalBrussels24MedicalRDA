...
const ERC20InboxAddress = "0x3ba61Cc3B113c8D4e16aAD618122A540F7d7B29b"
...
async function main() {
  ...
  const oldBalance = await l3Provider.getBalance("0xd1AE7F25ace194DF69eeF015a37C5EB9ED6b8733")
  let tx
  if (nativeToken === ethers.constants.AddressZero) {
    const inboxAddress = "0x3ba61Cc3B113c8D4e16aAD618122A540F7d7B29b"
  ...
  while (true) {
    const newBalance = await l3Provider.getBalance("0xd1AE7F25ace194DF69eeF015a37C5EB9ED6b8733")
