...
export interface SequencerInboxStubInterface extends utils.Interface {
  functions: {
    ...
    "initialize(address,(uint256,uint256,uint256,uint256),address)": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [string, ISequencerInbox.MaxTimeVariationStruct, string]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "validateBatchDataOverAvailDA(tuple)": EventFragment;
  };
  ...
  getEvent(
    nameOrSignatureOrTopic: "validateBatchDataOverAvailDA"
  ): EventFragment;
}
...
export interface validateBatchDataOverAvailDAEventObject {
  merkleProofInput: MerkleProofInputStructOutput;
}
export type validateBatchDataOverAvailDAEvent = TypedEvent<
  [MerkleProofInputStructOutput],
  validateBatchDataOverAvailDAEventObject
>;

export type validateBatchDataOverAvailDAEventFilter =
  TypedEventFilter<validateBatchDataOverAvailDAEvent>;
...
export interface SequencerInboxStub extends BaseContract {
  ...
  functions: {
    ...
    availBridge(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "validateBatchDataOverAvailDA(tuple)"(
      merkleProofInput?: MerkleProofInputStruct | null
    ): validateBatchDataOverAvailDAEventFilter;
    validateBatchDataOverAvailDA(
      merkleProofInput?: MerkleProofInputStruct | null
    ): validateBatchDataOverAvailDAEventFilter;
  };
  ...
  estimateGas: {
    ...
    availBridge(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    availBridge(overrides?: CallOverrides): Promise<PopulatedTransaction>;
